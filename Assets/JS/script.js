...
// Uses the current weather api to fetch latitude and longitude coordinates
...
// Uses latitude and longitude coordinates to fetch current weather and five-day forecast
...
// Select HTML element and display rounded temperature
...
// Displays current forecast of searched city
...
// Displays 5-day forecast of searched city
...
// City search saved to local storage
var saveCity = function(city) {

    // Prevents duplicate city from being saved and moves it to top of list
...
// Recent cities loads from local storage
var loadCities = function() {
    ...
    if (!cityArr) {
        ...
        // Limits saved cities to five most recent searched
        cityArr.shift();
    }
